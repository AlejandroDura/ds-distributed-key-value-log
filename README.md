...
a key-value log over all network nodes ensuring data replication, data consistency, data availability and fault tolerance. All system code is made from scratch, triying to approach real word solutions but on a small scale.
